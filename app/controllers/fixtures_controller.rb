class FixturesController < ApplicationController
  ...
  private
    ...
    def fixture_params
      params.require(:fixture).permit(:fixture_api_id, :referee, :timezone, :date, :timestamp, :periods_first, :periods_second, :venue_id, :venue_name, :venue_city, :status_long, :status_short, :status_elapsed, :league_api_id, :teams_home_api_id)
    end
end
