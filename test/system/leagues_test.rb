...
class LeaguesTest < ApplicationSystemTestCase
  ...
  test "should create league" do
    ...
    fill_in "Country code", with: @league.country_code
    fill_in "League api", with: @league.league_api_id
    fill_in "Logo", with: @league.logo
    fill_in "Name", with: @league.name
    fill_in "Seasons", with: @league.seasons
    fill_in "Type", with: @league.type
